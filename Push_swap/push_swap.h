...
#define INIT_PIVOT_FLAG int pivot = (*last_a)->value;	int8_t flag = 0;
#define INIT_SIZE_STEPS static int b_size = 0; int steps = 0, normalize;
#define CASE_1 {PB; ++b_size;}
#define CASE_2 {PB; b_size++; RB;}
#define CASE_3_1 while (steps){RB;--steps;}PB;
#define CASE_3 {CASE_3_1 while (steps < normalize){RRB;++steps;}}
#define CASE_4 while (steps < b_size){RRB;++steps;}PB;++steps;
#define CASE_4_1 while (steps > normalize) {RB;--steps;}
